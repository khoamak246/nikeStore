    ...
    <>
      ...
      >
        <div className="flex w-full h-full justify-center items-center">
          <div
            className={`bg-white w-[60%] md:w-[80%] sm:w-full rounded-lg flex overflow-hidden relative ${
          ...
          >
            <div className="w-[30%] xxsm:w-[20%] bg-slate-100">
              <div className="flex flex-col gap-6">
                ...
                <div className="w-full flex items-center gap-2 cursor-pointer bg-slate-300 py-2 pl-4">
                  <UserCircleIcon className="w-7 h-7 xsm:w-5 xsm:h-5" />
                  <p className="xsm:text-[0.6rem] xxsm:hidden">My account</p>
                </div>
                <div className="w-full flex items-center gap-2 cursor-pointer py-2 pl-4">
                  <StarIcon className="w-7 h-7 xsm:w-5 xsm:h-5" />
                  <p className="xsm:text-[0.6rem] xxsm:hidden">Password</p>
                </div>
                <div className="w-full flex gap-2 items-center cursor-pointer py-2 pl-4">
